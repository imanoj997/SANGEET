...
public class MainController implements Initializable {
	...
	Image playImage = new Image("ButtonImage/Play.png");
	Image pauseImage = new Image("ButtonImage/Pause.png");
	Image unmuteImage = new Image("ButtonImage/Unmute.png");
	Image muteImage = new Image("ButtonImage/Mute.png");
